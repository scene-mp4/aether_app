...
**Description**: AETHER is an IoT-based air pollution monitoring device that measures PM2.5 and CO₂, CO, and other combustible gas levels using air quality sensors. 
The device transmits real-time pollution and location data via WiFi to a mobile application, where users can view pollutant statistics and visualize air pollutant data on the app. The app also has pollutant prediction capabilities using machine learning, health advice based on recorded pollutant data, and other various features to make it convenient to use for senior healthcare facility caregivers.

**Technologies Used**: Flutter, Dart, IoT, Visual Studio Code, Arduino IDE, Firebase, Github, Git

**Features**:
- Air quality monitoring for PM2.5 and CO₂ levels
- Cloud-based data transmission using ESP32 WiFi connectivity
...
- Enables senior healthcare facility caregivers to identify pollution hotspots
